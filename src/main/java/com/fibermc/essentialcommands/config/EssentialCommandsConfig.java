...
public final class EssentialCommandsConfig extends Config<EssentialCommandsConfig> {
    ...
    @ConfigOption public final Option<Text>  NICKNAME_PREFIX =        new Option<>("nickname_prefix", parseText("{\"text\":\"~\",\"color\":\"red\"}"), TextUtil::parseText, str -> Text.Serialization.toJsonString(str, TextUtil.getWrapperLookup()));
    ...
    @ConfigOption public final Option<Text> AFK_PREFIX = new Option<>("afk_prefix", Text.literal("[AFK] ").formatted(Formatting.GRAY), TextUtil::parseText, str -> Text.Serialization.toJsonString(str, TextUtil.getWrapperLookup()));
